        ...
        >
          <Box
            sx={{
              height: "100%",
              width: "100%",
              backgroundImage: `url(${project_thumbnails.m5stack_tryout.thumbnail})`,
...
const project_thumbnails = {
  ...
  slic3r_tryout: { title: "slic3r tryout", thumbnail: slic3r_tryout_thumbnail },
  tappy_tryout: { title: "tappy tryout", thumbnail: tappy_tryout_thumbnail },
};
